...
var palabras = ['ALURA', 'AHORCADO', 'HTML', 'ORACLE', 'JAVASCRIPT', 'LOGICA', 'PROGRAMACION', 'ONE', 'VARIABLE', 'PHP','SCRUM','TRELLO','GITHUB'];
...
//hace que los botones de la pantalla de home desaparezcan y los de la de agregar palabra aparezcan
...
function guardarPalabra() {
  ...
  if(nuevaPalabra !== ""){
    ...
    alert("Ninguna palabra ha sido escrita")
  }
...
function iniciarJuego() {
  ...
  // hace que los de iniciar juego e agregar palabra desaparezcan
  document.getElementById("div-desaparece").style.display = 'none';
